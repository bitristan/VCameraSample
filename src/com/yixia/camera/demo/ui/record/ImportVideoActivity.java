...
public class ImportVideoActivity extends BaseActivity implements OnClickListener, OnPreparedListener, OnPlayStateListener {
		...
		if (!isFinishing() && mMediaObject != null && mMediaPart != null) {
			new AsyncTask<Void, Void, Boolean>() {
				...
				protected Boolean doInBackground(Void... params) {
					return FFMpegUtils.importVideo(mMediaPart, mWindowWidth, mVideoView.getVideoWidth(), mVideoView.getVideoHeight(), 0, 0, true);
				}
