...
public class ThemeRadioButton extends RadioButton implements android.widget.CompoundButton.OnCheckedChangeListener {
	...
	private void init() {
		...
		mColorSelected = getResources().getColor(R.color.camera_theme_selected_bgcolor);
